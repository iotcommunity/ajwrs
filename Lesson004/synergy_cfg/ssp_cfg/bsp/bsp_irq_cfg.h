...
#define BSP_IRQ_CFG_SCI8_RXI (15) /* SCI8 RXI: Priority 15 (lowest, not valid if using ThreadX) */
#define BSP_IRQ_CFG_SCI8_TXI (15) /* SCI8 TXI: Priority 15 (lowest, not valid if using ThreadX) */
#define BSP_IRQ_CFG_SCI8_TEI (15) /* SCI8 TEI: Priority 15 (lowest, not valid if using ThreadX) */
#define BSP_IRQ_CFG_SCI8_ERI (15) /* SCI8 ERI: Priority 15 (lowest, not valid if using ThreadX) */
