...
/*******************************************************************************************************************//**
 * @addtogroup BSP_DK2M_SDRAM
 * @brief SDRAM initialization
 *
 * This file contains code that the initializes SDRAMC and SDR SDRAM device memory mounted on a DK2 development board.
 * @{
 **********************************************************************************************************************/
