 ...
 * Extends TIMER_API.
 *
 * This module implements the TIMER_API using the General PWM Timer (GPT) peripherals GPT32EH, GPT32E, GPT32.
...
#define GPT_CODE_VERSION_MINOR (0)
